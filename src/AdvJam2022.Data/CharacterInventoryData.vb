Public Module CharacterInventoryData
    ...
    Friend Sub Initialize()
        ...
        ExecuteNonQuery(
            ...
            (
                ...
                [{InventoryIdColumn}] INT NOT NULL UNIQUE,
    ...
    Public Sub Write(characterId As Long, inventoryId As Long)
        ReplaceRecord(Of Long, Long)(AddressOf Initialize, TableName, (CharacterIdColumn, characterId), (InventoryIdColumn, inventoryId))
    End Sub
End Module
